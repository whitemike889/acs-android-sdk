...
public class ACSClientDialog extends Dialog {
    ...
    public ACSClientDialog(Context _context, String url, DialogListener listener, DlgCustomizer dlgCustomizer) {
        super(_context);
    ...
    private void setUpWebView() {
        ...
        webView.setWebViewClient(new ACSWebViewClient());
    ...
    private class ACSWebViewClient extends WebViewClient {

        @Override
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
        	String method = "ACSClientDialog.ACSWebViewClient.shouldOverrideUrlLoading";
            
        	Log.d(method, "About to load: " + url);

            if (url.startsWith(ACSClient.REDIRECT_URI)) {
                ...
                if (error == null) {
                    ...
                    listener.onACSClientError(new ACSClientError(error));
                }

                ACSClientDialog.this.dismiss();
                return true;

            } else if (url.startsWith(ACSClient.CANCEL_URI)) {
                listener.onCancel();
                ACSClientDialog.this.dismiss();
                return true;
            } 
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
        	String method = "ACSClientDialog.ACSWebViewClient.onPageStarted";
...
//        }
        ...
        @Override  
        public void onPageFinished(WebView view, String url) {  
        	String method = "ACSClientDialog.ACSWebViewClient.onPageFinished";
            super.onPageFinished(view, url);  
